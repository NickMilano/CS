    ...
    while Q.isEmpty() == False:
      ...
      if currentNode not in V:
        ...
        for child in successors:
          ...
          childCost = child[2]
          newPath = currentPath + [childPath]
          newCost = currentCost + childCost
          Q.update((childNode, newPath, newCost), newCost)
    ...
    while Q.isEmpty() == False:
      ...
      if currentNode not in V:
        ...
        for child in successors:
          ...
          newPath = currentPath + [childPath]
          newCost = currentCost + childCost
          Q.update((childNode, newPath, newCost), newCost + heuristic(childNode, problem))
